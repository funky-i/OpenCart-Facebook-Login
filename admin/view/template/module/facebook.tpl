...
<div class="box">
  ...
  <div class="content">
	...
	<?php } ?>
          ...
          <td><input type="text" name="facebook_apikey" id="facebook_apikey" size="50" value="<?php echo $facebook_apikey; ?>" /> </td>
	</tr>
      	<tr>
          <td><span class="required">*</span> <?php echo $entry_apisecret; ?></td>
          <td><input type="text" name="facebook_apisecret" id="facebook_apisecret" size="50" value="<?php echo $facebook_apisecret; ?>" /> </td>
	</tr>
      	<tr>
          <td><span class="required">*</span> <?php echo $entry_pwdsecret; ?></td>
          <td><input type="text" name="facebook_pwdsecret" id="facebook_pwdsecret" size="10" value="<?php echo $facebook_pwdsecret; ?>" /><br>
	...
	<td><?php echo $entry_button; ?></td>
	  <td><input type="text" name="facebook_button_<?php echo $language['language_id']; ?>" id="facebook_button_<?php echo $language['language_id']; ?>" size="50" value="<?php echo ${'facebook_button_' . $language['language_id']}; ?>" />
